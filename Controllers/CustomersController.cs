...
namespace TaskAuthenticationAuthorization.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            // Fetch the customer along with the related User using Include
    var customer = await _context.Customers
        .Include(c => c.User) // This ensures the User navigation property is loaded
        .FirstOrDefaultAsync(c => c.ID == id);
            ...
            if (customer == null)
            {
             ...
             ViewData["Discount"] = new SelectList(Enum.GetValues(typeof(Discount)));
            return View(customer);
        }
        ...
        public async Task<IActionResult> Edit(int id, [Bind("ID,LastName,FirstName,Address,Discount")] Customer customer)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    var dbCust = await _context.Customers.FindAsync(id);
                    if(dbCust == null)
                    {
                        return NotFound();
                    }
            ...
            dbCust.Address = customer.Address;
            dbCust.Discount = customer.Discount;
